...
class SegModel(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.lang_stage1 = RowColTransformer(
    ...
    def forward(self, x, l):
        #x is one image, l is one of the corresponding sentence
        input_shape = x.shape[-2:]

        # Stage 1
        last_hidden_states, att_mask_, head_mask,cls_token1 = self.lang_stage1(l)
